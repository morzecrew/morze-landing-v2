...
const FOUNDERS = [
  ...
  },
  {
    ...
    bio: 'Более 6 лет в коммерческой разработке. Образование в области программного обеспечения. Создатель платформы Morze Assistant. Широкий опыт проектирования и запуска корпоративных систем на облачных платформах. Глубокая экспертиза в архитектуре и разработке масштабируемых веб-интерфейсов.',
  },
  {
    name: 'Лев Литвинов',
    role: 'Главный архитектор систем',
